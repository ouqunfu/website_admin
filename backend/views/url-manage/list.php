...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo Url::toRoute('url-manage/list');?>">URL规则管理</a></li>
  </ol>
</section>
          ...
          <div id="contents-column-list-info" class="dataTables_wrapper dt-bootstrap">
            ...
            <div class="row">
              <div class="col-sm-12 table-responsive">
                <table id="contents-url-rule-list" class="table table-bordered table-hover dataTable" role="grid">
                  <thead>
                  <tr role="row">
                    <th width="3%">
                      ID
                  ...
                  <tr role="row" class="odd">
                    ...
                    <td >contents</td>
                    <td>category</td>
                    <td>news/china/1000.html</td>
                    <td>{$categorydir}{$catdir}/index.html|{$categorydir}{$catdir}/{$page}.html</td>
                    <td>
                  ...
                  <tr role="row" class="even">
                    ...
                    <td>contents</td>
                    <td>show</td>
                    <td>list-1-1-1.html</td>
                    <td>list-{$catid}-{$id}-{$page}.html</td>
                    <td>
                      <a href="javascript:void(0)">编辑</a>
                      <a href="javascript:void(0)">删除</a>
                    </td>
