                ...
                <form class="form-horizontal">
                  <div class="row">
                    <div class="form-group">
                      <label for="urlName" class="col-md-2 control-label">URL规则名称</label>
                      <div class="col-md-5">
                  ...
                  <div class="row">
                    <div class="form-group">
                      <label for="parent" class="col-md-2 control-label">所属模块</label>
                      <div class="col-md-5">
                  ...
                  <div class="row">
                    <div class="form-group">
                      <label for="urlExample" class="col-md-2 control-label">URL示例</label>
                      <div class="col-md-5">
                  ...
                  <div class="row">
                    <div class="form-group">
                      <label for="urlRule" class="col-md-2 control-label">URL规则</label>
                      <div class="col-md-5">
                        <div class="row">
