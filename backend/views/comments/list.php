...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo Url::toRoute('comments/list');?>">评论管理</a></li>
  </ol>
</section>
      ...
      <div class="box">
        <div class="box-body">
          <div id="contents-column-list-info" class="dataTables_wrapper dt-bootstrap">
            ...
            <div class="row">
              <div class="col-sm-3">
                <button type="button" class="btn bg-purple">删除</button>
                <button type="button" class="btn bg-primary">审核</button>
                <button type="button" class="btn bg-aqua">取消审核</button>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-5">
