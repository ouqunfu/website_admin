...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo Url::toRoute('users/list'); ?>">用户管理</a></li>
  </ol>
</section>
        ...
        <div class="box-body">
          <div id="contents-tags-list-info" class="dataTables_wrapper dt-bootstrap">
            <div class="col-sm-4 col-md-1 margin">
              <a href="<?php echo Url::toRoute('users/add'); ?>">
                <button type="button" class="btn btn-block btn-primary">添加用户</button>
              </a>
            </div>
