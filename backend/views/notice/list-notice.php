...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo Url::toRoute('notice/list');?>">公告管理</a></li>
  </ol>
</section>
          ...
          <div id="contents-column-list-info" class="dataTables_wrapper dt-bootstrap">
            <div class="row">
              <div class="col-sm-4 col-md-1">
                <a href="<?php echo Url::toRoute('notice/add-notice');?>">
                  <button type="button" class="btn btn-block btn-primary">添加公告</button>
                </a>
              </div>
            </div>
            <div class="row">
