                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                      <label for="parent" class="col-sm-2 control-label">所属栏目</label>
                    ...
                    <div class="form-group">
                      <label for="isNav" class="col-sm-2 control-label">在导航中显示</label>
                      <div class="col-sm-8 col-md-5">
                  ...
                  <div class="tab-pane" id="tab_4">
                    ...
                    <div class="form-group">
                      <label for="img" class="col-sm-2 control-label">栏目说明图片</label>
                      <div class="col-sm-8 col-md-5">
