...
?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo Url::toRoute('customs/add-user-field'); ?>">添加字段</a></li>
    </ol>
  </section>
        ...
        <div class="box">
          <form class="form-horizontal">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="field_is_show" class="col-sm-2 control-label">是否注册页显示</label>
                <div class="col-sm-8 col-md-5">
                  <select class="form-control" id="field_is_show">
                    <option value="0">否</option>
                    <option value="1">是</option>
                  </select>
                </div>
                <div class="col-sm-1 custom-input-icon">
                  <span data-toggle="tooltip" data-placement="top" class="badge bg-yellow-gradient custom-tooltip"
                        data-original-title="用户自定义字段是否在注册页面显示！">!</span>
                </div>
              </div>
            </div>
