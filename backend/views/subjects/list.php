...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo Url::toRoute('subjects/list');?>">专题管理</a></li>
  </ol>
</section>
      ...
      <div class="box">
        <div class="box-body">
          <div id="contents-column-list-info" class="dataTables_wrapper dt-bootstrap">
            <div class="row">
              <div class="col-sm-1">
                <a href="<?php echo Url::toRoute('subjects/add');?>">
                  <button type="button" class="btn btn-block btn-primary">添加专题</button>
                </a>
              </div>
            </div>
            <div class="row">
